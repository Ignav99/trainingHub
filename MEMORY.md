...
- **Visión:** PDF de licencias 2025-2026 leído. Clip `prueba 2.mp4` (Veo 21 s, kit blanco vs azul). Detector RF-DETR Apache; tracker `roboflow/trackers` BoT-SORT. Plan: `docs/VISION_PLAN.md`.
