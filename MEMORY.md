...
La pestaña **Convocatoria** abre **Cartel** (JPEG/PDF): todos los convocados por dorsal, sin 11 titular. Citación (hora/lugar) y kit local/visitante editables; camiseta+pantalón+medias de Configuración → Equipaciones. Campos `partidos.hora_citacion`, `lugar_citacion`, `kit_convocatoria`.
