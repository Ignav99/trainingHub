    ...
    <div className="min-h-[100dvh] overflow-y-auto px-5 py-4 pb-10">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-500 mt-1">Pestañas: acta, once, goles, stats, faltas, notas y cierre. 1ª y 2ª parte por separado; al cerrar se vuelcan los totales al informe.</p>
        </div>
      </div>
